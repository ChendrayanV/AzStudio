...
/// <summary>
/// Port of AzStudio.App's ServiceBusTabViewModel — business logic untouched, the only
/// change is SendMessageWindow.Prompt(owner) becoming the async AvaloniaDialogs call.
/// </summary>
public partial class ServiceBusTabViewModel : ObservableObject
{
    ...
    private async Task SendDirectQueueMessageAsync()
    {
        ...
        var result = await AvaloniaDialogs.PromptSendMessageAsync();
